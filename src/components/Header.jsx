        ...
        <div className="flex justify-between items-center px-4 py-2">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <nav className="flex items-center space-x-6">
              <NavLink to="/" icon={<Home size={12} />} text="Home" />
              <NavLink to="/about" icon={<Info size={12} />} text="About" />
              <NavLink to="/contact" icon={<Phone size={12} />} text="Contact" />
              <NavLink to="/services" icon={<Info size={12} />} text="Services" />
              <NavLink to="/eventcatering" icon={<Info size={12} />} text="Event Catering" />
